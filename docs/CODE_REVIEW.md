...
**سیاست منطق تجاری:** هسته Rust (`rust/hesabyar-core`) تنها مکان پیاده‌سازی منطق تجاری، محاسبات، قوانین و اعتبارسنجی‌های جدید است. هر درخواست Pull که شامل منطق تجاری، محاسبه، یا اعتبارسنجی جدید مستقیماً در Kotlin باشد (خارج از لیست استثناهای زیر) باید در بازبینی علامت زده شود و به سمت Rust هدایت شود.

**لیست استثناها (پشتیبانی از سوئیچ به عقب موقت):**
- تبدیل تقویم جلالی
- قالب‌بندی پول
- پارسر NLP آفلاین
