...
object HesabyarCore {
    ...
    fun computeAnalytics(transactions: List<Transaction>, loans: List<Loan>, installments: List<Installment>, categories: List<Category>, bankLoans: List<BankLoan> = emptyList()): AnalyticsData? = __PKG__.computeAnalytics(transactions, loans, installments, categories, bankLoans)
    fun computeDashboardData(transactions: List<Transaction>, loans: List<Loan>, installments: List<Installment>, bankLoans: List<BankLoan> = emptyList()): DashboardData? = __PKG__.computeDashboardData(transactions, loans, installments, bankLoans)
