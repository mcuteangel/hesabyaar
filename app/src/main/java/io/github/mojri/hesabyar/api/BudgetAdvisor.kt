...
object BudgetAdvisor {
    ...
    fun getOfflineForecast(
        ...
        if (estimatedBalance < 0) {
            ...
            sb.append("با نگرانی خفیف به استحضار می‌رساند مخارج متوسط شما به همراه اقساط پیش رو، احتمالاً تراز نقدی شما در ماه آینده را با **کسری حدودی $formattedEstimatedBalance ${CurrencyFormatter.currentUnit}** روبرو خواهد کرد.\n\n")
            ...
            sb.append("خوشبختانه بررسی الگوی دخل و خرج نشان می‌دهد جریان درآمدی شما برای پوشش مخارج جاری و تصفیه اقساط کاملاً کافی است و پیش‌بینی می‌شود ماه آینده را با **مازاد بودجه حدودی $formattedEstimatedBalance ${CurrencyFormatter.currentUnit}** پشت سر بگذارید.\n\n")
