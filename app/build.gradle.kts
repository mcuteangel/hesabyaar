...
object HesabyarCore {
    ...
    fun encryptBackup(json: String, key: ByteArray): ByteArray = $pkg.encryptBackup(json, key)
    @Throws(HesabyarException::class) fun decryptBackup(data: ByteArray, key: ByteArray): String = $pkg.decryptBackup(data, key)
    ...
    @Throws(HesabyarException::class) fun buildEncryptedBackupFile(json: String, key: ByteArray): ByteArray = $pkg.buildEncryptedBackupFile(json, key)
    @Throws(HesabyarException::class) fun parseEncryptedBackupFile(data: ByteArray, key: ByteArray): String = $pkg.parseEncryptedBackupFile(data, key)
