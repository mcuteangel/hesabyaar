...
| 011  | Personal loan ledger redesign (`plans/011-personal-loan-ledger-redesign.md`, planned at `f425bd0`) | P1 | XL | — | IN PROGRESS on `feature/person-loan-ledger` (Phase 0 loan bug fixes done and committed; Phases 1-5 pending) |
